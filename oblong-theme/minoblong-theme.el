...
(let ((bg       "#111111")    ; XTerm background
      (fg       "#7c7c7c")    ; XTerm foreground
      (bg-alt   "#1c1c1c")    ; XTerm color8/color2
      (fg-alt   "#666666")    ; XTerm color1
      (accent   "#e35420")    ; XTerm bright cyan
      (light-grey   "#999999")    ; XTerm color11
      (green    "#777777")    ; XTerm color6 (teal)
  ...
  (custom-theme-set-faces
   ...
   ;; Search
   `(isearch ((t (:foreground ,fg :background ,selection :weight bold))))
   `(match ((t (:background ,selection :foreground ,fg))))
   `(completions-common-part ((t (:background ,selection :foreground ,fg))))
   ...
   `(ivy-minibuffer-match-highlight ((t (:background ,selection ))))
   `(ivy-minibuffer-match-1 ((t (:background ,selection ))))
   `(ivy-minibuffer-match-face-1 ((t (:background ,selection ))))
   `(ivy-minibuffer-match-face-2 ((t (:background ,selection))))
